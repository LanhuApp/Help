...
然后打开【蓝湖 Axure 客户端】，点击“上传”，即可将该 Axure 文档上传至蓝湖 Web 端；
...
![](.gitbook/assets/12-10.gif)


### 4.上传 Word / PDF /  Excel / PPT / 外部文档链接格式文档
...
#### 9.3 上传的不是当前 Axure 文档

解决办法：

在 RP 文档右侧下拉内切换成想要上传的文档。


#### 9.4 一直解析中（进度为0%，长于1分钟）
